...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[90dvh] flex flex-col justify-center pt-28 pb-20 bg-[var(--bg-void)] overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 w-full z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            {/* Main Title */}
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight text-[var(--ink-primary)] mb-3 font-display uppercase">
              Kilani Sai Nikhil
            </h1>

            {/* Subtitle / Role */}
            <div className="text-base md:text-lg font-mono font-semibold text-[var(--brand-primary)] mb-5 flex items-center gap-2">
              <span>AI-Augmented Systems &amp; Deep Tech Engineer</span>
            </div>

            {/* Bio Narrative */}
            <p className="text-sm md:text-base leading-relaxed text-[var(--ink-secondary)] mb-6 max-w-xl">
            ...
            <div className="mb-7 border border-[var(--border-subtle)] bg-[var(--bg-surface)] p-3 max-w-lg w-full shadow-sm">
              {/* Command Tabs */}
              ...
              <div className="flex items-center justify-between font-mono text-xs text-[var(--ink-primary)] px-1">
                ...
                <button
                  onClick={handleCopy}
                  className="p-1 text-[var(--ink-muted)] hover:text-[var(--ink-primary)] transition-colors shrink-0 ml-2"
                  title="Copy command"
                >
          ...
          <div className="lg:col-span-5 w-full flex justify-center items-center">
            <div className="relative w-full max-w-[340px] aspect-[4/5] border border-[var(--border-subtle)] bg-[var(--bg-surface)] p-2 select-none shadow-lg group">
              {/* Corner tech ticks */}
      ...
      <div className="max-w-6xl mx-auto px-6 w-full mt-16 z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 border-t border-[var(--border-subtle)] pt-8">
          {stats.map((stat) => (
            <div
              key={stat.label}
              className="p-5 border border-[var(--border-subtle)] bg-[var(--bg-surface)]/80 hover:border-[var(--border-active)] transition-colors duration-300 shadow-sm"
            >
