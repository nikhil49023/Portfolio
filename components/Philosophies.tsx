...
export function Philosophies() {
  ...
  const engineeringAxioms = [
    ...
    {
      num: '02',
      title: 'AI Augments Velocity, Architecture Governs Quality',
      tagline: 'High-Leverage Workflows Over Manual Drudgery.',
      icon: Sparkles,
      accent: '#06B6D4',
      badgeClass: 'text-cyan-600 bg-cyan-500/10 border-cyan-500/20',
      desc: 'The best engineering is neither pure manual coding nor blind LLM prompting. It is an agentic dialogue where first-principles architectural vision guides autonomous agent swarms to ship tested, production-grade systems in record time.',
      quote: 'AI is a velocity multiplier. Architectural vision determines the direction.',
    },
    {
      num: '03',
